...
When you start building your own Yggdrasil Network cluster you may face the dilemma of either not connecting to the wider network or having all of the nodes in your cluster beeing exposed to it. Using this script you can form a private group of nodes that can reach each others ports while keeping them unavailable to the wider network.
